...
public class chat_server extends javax.swing.JFrame {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(msg_text, javax.swing.GroupLayout.DEFAULT_SIZE, 343, Short.MAX_VALUE)
                        .addGap(18, 18, 18)
    ...
    public static void main(String args[]) {
        ...
        try{
            ...
            ss = new ServerSocket(1201); // server listen to this port number(1201)
            ...
            while(!msgin.equals("exit")){
                ...
                msgin = din.readUTF();
                msg_area.setText(msg_area.getText().trim()+"/n"+msgin); // displaying messages from the client
            }
